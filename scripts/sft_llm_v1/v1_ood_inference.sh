...
#     echo "Inferencing with rank ${rank} on GPU ${gpu_id}..."
#     save_path="./logs/sft_answer/model:${model_name}_${checkpoint}/test:${test_dataset}_samples:${num_examples}/$(printf "%05d" ${rank})-$(printf "%05d" ${world_size}).json"
